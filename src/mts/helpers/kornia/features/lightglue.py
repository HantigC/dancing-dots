...
class LightGlue(Module):
    ...
    features: ClassVar[Dict[str, Any]] = {
        "superpoint": {
            "weights_name": "superpoint_lightglue",
            "input_dim": 256,
        },
        "dedodeb": {
            "weights_name": "dedodeb_lightglue",
            "input_dim": 256,
        },
        "dedodeg": {
            "weights_name": "dedodeg_lightglue",
            "input_dim": 256,
        },
        "disk": {
            "weights_name": "disk_lightglue",
            "input_dim": 128,
        },
        "aliked": {
            "weights_name": "aliked_lightglue",
            "input_dim": 128,
        },
        "sift": {
        ...
        "keynet_affnet_hardnet": {
            "weights_name": "keynet_affnet_hardnet_lightglue",
            "input_dim": 128,
            "width_confidence": -1,
            "depth_confidence": -1,
            "add_laf": True,
    ...
    def __init__(self, features: str = "superpoint", **conf_) -> None:  # type: ignore
        ...
        if conf.weights is not None:
            ...
            fname = f"{conf.weights_name}_{self.version}.pth".replace(".", "-")
